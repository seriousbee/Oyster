...
public class JourneyCosts {
    public final BigDecimal PEAK_LONG_JOURNEY_PRICE = new BigDecimal(3.80);
    ...
    public static final BigDecimal OFF_PEAK_JOURNEY_PRICE = new BigDecimal(2.40);
    public static final BigDecimal PEAK_JOURNEY_PRICE = new BigDecimal(3.20);
}
